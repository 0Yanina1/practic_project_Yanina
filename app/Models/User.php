...
class User extends Authenticatable
{
    ...
    public function setPermissions(\Illuminate\Database\Eloquent\Collection $permissions): void
    {
    ...
    public function setRoles(\Illuminate\Database\Eloquent\Collection $roles): void
    {
        $this->roles = $roles;
    }
